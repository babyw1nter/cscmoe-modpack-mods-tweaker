...
@Mod.EventBusSubscriber(modid = CMMT.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config {
    private static final ForgeConfigSpec.Builder COMMON_BUILDER = new ForgeConfigSpec.Builder();
    private static final ForgeConfigSpec.Builder CLIENT_BUILDER = new ForgeConfigSpec.Builder();

//    public static final String CATEGORY_ARS_NOUVEAU = "Ars Nouveau";
...
//            .defineListAllowEmpty("items", List.of("minecraft:iron_ingot"), Config::validateItemName);
    ...
    static final ForgeConfigSpec COMMON_CONFIG = COMMON_BUILDER.build();
    static final ForgeConfigSpec CLIENT_CONFIG = CLIENT_BUILDER.build();

    static {
        COMMON_BUILDER.comment("Ars Nouveau").push("Ars Nouveau");
        // PortalTileCanTeleportPlayer
    }
